...
namespace ImgOrg.Tests
{
    ...
    public class RaiFileTest
    {
        ...
        /// Use Persist's XmlFile<T> if no variables allowed or Persist's MemSettingsFile<T> if variables can be used;
    ...
    public class ImageTreeFileTest
    {
        static internal string TestDir => GeneralTestSettings.Tests.TestDir;
        public ImageTreeFileTest()
        {
            //
            // TODO: Add constructor logic here
            //
